...
<div id='latest-home'>
  ...
  <div id='latest-item'>
    {data.filter((item)=>item.id===31).map((item,index)=>{
      return(
        <>
...
{data.filter((item)=>item.id===32).map((item,index)=>{
    ...
    {data.filter((item)=>item.id===37).map((item,index)=>{
      return(
...
<div id='bottom-item'>
{data.filter((item)=>item.id===34).map((item,index)=>{
  return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
...
<div id="bottom-item">
{data.filter((item)=>item.id===35).map((item,index)=>{
  return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===38).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===39).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===40).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-right'>
   ...
   <div id="rigth-bottom-item-1">
    {data.filter((item)=>item.id===42).map((item,index)=>{
      return(
      <>
      <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
      <img src={item.img} alt='not found' id='img-right-bottom'/>
   ...
   <div id="rigth-bottom-item-1">
    {data.filter((item)=>item.id===43).map((item,index)=>{
      return(
      <>
      <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
      <img src={item.img} alt='not found'  id='img-right-bottom'/>
