...
<div id='latest-home'>
  ...
  <div id='latest-item'>
    {data.filter((item)=>item.id===49).map((item,index)=>{
      return(
        <div key={index}>
...
<div id='latest-item'>
{data.filter((item)=>item.id===50).map((item,index)=>{
      return(
        <>
        <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
        <img src={item.img} alt='not there' id='thelatest-img'/>
    ...
    {data.filter((item)=>item.id===51).map((item,index)=>{
      return(
...
<div id='bottom-item'>
{data.filter((item)=>item.id===52).map((item,index)=>{
  return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===46).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===60).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===56).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
...
<div id='bottom-item'>
  {data.filter((item)=>item.id===47).map((item,index)=>{
    return(
    <>
    <Link to={`/details/${item.id}/${item.cat}`}  id='link'>
    <img src={item.img} alt='not there'  id='bottom-img'/>
